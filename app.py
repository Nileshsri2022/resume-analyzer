    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/Nileshsri2022/resume-analyzer' target='_blank' style='text-decoration: none;'>
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://mapsofarabia.com/wp-content/uploads/2024/09/12085327_20944154-scaled-1-2048x1366.jpg'}"
                     alt="Nilesh Srivastava"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://mapsofarabia.com/wp-content/uploads/2024/09/12085327_20944154-scaled-1-2048x1366.jpg';">
                <h2 class="profile-name">Nilesh srivastava</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/Nileshsri2022/" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/patel-hetkumar-sandipbhai-8b110525a/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:nilesh.srivastava.51273@gmail.coms" class="social-link" target="_blank">
